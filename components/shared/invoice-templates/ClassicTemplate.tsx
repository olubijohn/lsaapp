...
export function ClassicTemplate({
  ...
  return (
    <div className="invoice-document relative bg-white shadow-lg">
      <div
        className="pt-10 px-6 pb-6 h-full flex flex-col gap-6"
        style={{ fontFamily: "Inter, sans-serif" }}
      >
        <div className="absolute -top-3 inset-x-0 flex items-center justify-center gap-2 place-items-center">
          ...
          <div className="flex justify-between gap-8 p-4">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {taxItems.map((item) => (
                    <tr
                      key={item.taxCode}
                      className="border-b border-dashed border-gray-50 text-sm font-semibold text-right"
                    >
            ...
            <div className="space-y-1 text-sm flex-1">
              ...
              <div className="flex justify-between ">
                ...
                <span className=" text-text-primary font-medium whitespace-nowrap">
                  {formatCurrency(document.totalAmount, document.currencyCode)}
                </span>
              </div>
              <hr />
        ...
        <div className="flex justify-between items-start gap-8 text-text-tertiary font-medium text-xs mb-2">
          <div className="flex-1 ">
            ...
            <div className=" text-text-primary">
              ...
              <p>
                Account Number: {fiscalizationConfig.bankDetails?.accountNumber}
              </p>
