...
export function SimpleTemplate({
  ...
  const resolvedQrCodeUrl =
    ...
    (isMalawi
      ...
      : document.fiscalDetail?.qrCodeUrl);
  console.log(fiscalizationConfig);
  ...
  return (
    <div className="invoice-document relative bg-white shadow-lg ">
      ...
      >
        ...
        <div className="border border-gray-300 border-dashed rounded-lg overflow-auto space-y-3">
          <table className="w-full text-sm">
            ...
            <tbody>
              {items.map((item, index) => (
                <tr
                  key={index}
                  className="border-t border-b text-xs font-medium"
                >
                  ...
                  <td className="px-4 py-2 text-right whitespace-nowrap">
                    {formatCurrency(item.discountAmount, document.currencyCode)}
                  </td>
          ...
          <div className="flex justify-between gap-10 p-2">
            <table className="w-full text-xs mb-4 flex-1">
              <thead
                className="text-white"
                style={{ backgroundColor: settings.themeColor }}
              >
                <tr className=" font-semibold text-xs whitespace-nowrap">
