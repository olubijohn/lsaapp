    ...
    return (
        <div className="h-[80vh] flex flex-col items-center justify-center space-y-6">
            ...
            <div className="text-center space-y-2">
                <h1 className="text-3xl font-black text-slate-800 tracking-tighter">Academic Staff Module</h1>
                <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-xs max-w-xs mx-auto leading-relaxed">
                    This module is currently being synchronized with the Intelligence Core.
                </p>
            </div>
